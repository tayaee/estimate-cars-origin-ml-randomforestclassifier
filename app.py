...
st.markdown(
    "Random Forest Classifier prediction. Adjust parameters for instant results. Find code [here](https://github.com/tayaee/estimate-cars-origin-ml-randomforestclassifier)"
)
